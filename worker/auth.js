// Single shared-password gate for the whole app (this is a small internal
// tool, not a multi-tenant product - one password for everyone who's allowed
// in is the right amount of complexity for now). Sessions are a signed,
// stateless cookie (HMAC over an expiry timestamp) rather than a DB table,
// so login doesn't cost a D1 round-trip on every request.
//

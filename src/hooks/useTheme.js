...
// remember it, same idea as the artifact dark/light convention: bare :root
// holds the dark defaults, an explicit [data-theme] attribute overrides in
// either direction, prefers-color-scheme only matters until that happens.
const KEY = "barkod:tema";

...
// "top" (mevcut yatay sekme şeridi) vs "sidebar" (sol menü) - kullanıcı
// ikisini canlıda deneyip karar verebilsin diye bir geçiş düğmesi. Tercih
// localStorage'da kalıcı, aynı hooks/useTheme.js deseninde.
const KEY = "barkod:navDuzeni";
